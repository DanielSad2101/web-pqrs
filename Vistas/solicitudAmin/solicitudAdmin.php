...
<table class="table table-sm table-bordered dt-responsive nowrap" 
        id="tablaSolicitudAdminDataTable" style="width:100%">
    <thead>
    ...
    <?php while($mostrar = mysqli_fetch_array($respuesta)){ ?>
        <tr>
            ...
            <td><button class="btn btn-info btn sm"
                        onclick="obtenerDatosSolucion('<?php echo $mostrar['idSolicitud'] ?>')"
                        data-toggle="modal" data-target="#modalAgregarSoluciomSolicitud">
                   <span class="fas fa-edit"></span> Responder Solicitud
                </button> 
            ...
            <td>
                ...
                <button class="btn btn-danger btn sm"
                    onclick="eliminarSolicitudAdmin(<?php echo $mostrar['idSolicitud'] ?>)">
    ...
    <script>
        $(document).ready(function(){
         $('#tablaSolicitudAdminDataTable').DataTable({
            language : {
